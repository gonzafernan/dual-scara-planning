...
import five_bar_robot as fb # noqa
...
def five():
    ...
    five.endEff = np.array([0.0, 0.3, 0.0])
    five.assMode = 1
    return five
...
def test_forward(five):
    # ++
    five.q = np.array([0.52040625, 1.30998849, 0.0])
    assert AssertionError != np.testing.assert_allclose(
        five.fkine(), np.array([0.0, 0.3, 0.0]), rtol=1e-8, atol=1e-7)
    # -+
    five.arms[0].wkMode_ = -1
    five.q = np.array([1.83160416, 1.30998849, 0.0])
    assert AssertionError != np.testing.assert_allclose(
        five.fkine(), np.array([0.0, 0.3, 0.0]), rtol=1e-8, atol=1e-7)
    # --
    five.arms[1].wkMode_ = -1
    five.q = np.array([1.83160416, 2.6211864, 0.0])
    assert AssertionError != np.testing.assert_allclose(
        five.fkine(), np.array([0.0, 0.3, 0.0]), rtol=1e-8, atol=1e-7)
    # +-
    five.q = np.array([0.52040625, 2.6211864, 0.0])
    five.arms[0].wkMode_ = 1
    assert AssertionError != np.testing.assert_allclose(
        five.fkine(), np.array([0.0, 0.3, 0.0]), rtol=1e-8, atol=1e-7)
